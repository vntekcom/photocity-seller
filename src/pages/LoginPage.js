...
import { requestLoginUser, actFetchUserRequest } from '../actions/index';
                                    ...
                                    <div className="col-lg-6">
                                        <div className="p-5">
                                            <div className="text-center">
                                                <h1 className="h4 text-gray-900 mb-4">Welcome Seller!</h1>
                                            </div>
                                            ...
                                            <div className="text-center">
                                                Chưa có tài khoản? <Link to="/register" className="small">Đăng ký ngay.</Link>
                                            </div>
                                        </div>
                                    </div>
                                </div>
